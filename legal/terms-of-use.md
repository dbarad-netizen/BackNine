...
**BackNine is not a medical provider and does not provide medical advice, diagnosis, or treatment.** You must read and agree to the [Medical & Health Disclaimer](./medical-disclaimer.md), which is incorporated into these Terms. Among other things, you agree to **consult a qualified healthcare professional before beginning or changing any exercise program or diet**, and you assume all risks associated with any activity you choose to undertake.
...
The Service includes automated, AI-generated features such as chat, weekly insights, daily briefings, goal plans, workout and meal parsing, and gear suggestions. To provide these, your inputs (for example, chat messages, descriptions, or meal photos) and certain health data may be sent to our third-party AI provider for processing (see the [Privacy Policy](./privacy-policy.md)).
...
*This document is provided as a template and does not constitute legal advice. Please have it reviewed by a licensed attorney before relying on it.*
