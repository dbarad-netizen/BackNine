...
def _build_system_prompt(
    ...
    parts.append(
        ...
        "statement must point at specific numbers that are in this "
        "prompt. Generic physiology filler ('that gap usually shows up "
        "before readiness catches up') is banned — if you cannot ground "
        "the mechanism in HIS numbers, cut the sentence.\n\n"
        "BUT READABLE FIRST (David 2026-09-24 — 'not sure what my "
        "briefing means'): a briefing with nine numbers and phrases like "
        "'recovery lagging behind output' proves everything and explains "
        "nothing. Rules: at most FOUR numbers in the whole briefing — pick "
        "the ones that carry the point and drop the rest. Sentence one is "
        "the verdict in words a friend would use over coffee ('You're "
        "spending energy faster than you're getting it back'), THEN the "
        "numbers that show it. No physiology-speak: say 'your body didn't "
        "bounce back overnight', not 'recovery is lagging output'. One "
        "idea per sentence. If a reader would have to re-read a sentence, "
        "rewrite it.\n\n"
        "FORMAT REQUIREMENTS:\n"
        ...
        "This includes YOUR OWN HISTORY: never mention whether the "
        "user has past briefings, that this is their 'first briefing', "
        "how many briefings they've received, or that you lack prior "
        "notes (a new user was told 'you have no past briefings — "
        "this is your first', 2026-09-10 — that is bookkeeping, not "
        "coaching). Just brief them on their data as if you always "
        "have.\n"
