...
def _readiness_progress(cur_rows: list, prev_rows: list) -> Optional[dict]:
    ...
    return {
        ...
        "period_days": len(cur_vals), "previous_period_days": len(prev_vals), "window_days": 30, "target": target,
...
def _hrv_progress(cur_rows: list, prev_rows: list) -> Optional[dict]:
    ...
    return {
        ...
        "period_days": len(cur_vals), "previous_period_days": len(prev_vals), "window_days": 30, "target": None,
