      ...
      <main className="max-w-2xl md:max-w-3xl landscape:md:max-w-4xl mx-auto px-4 md:px-6 py-6 space-y-6">
        ...
        {section === "coaching" && (() => {
          ...
          <div className="space-y-6">
            ...
            {/* CPAP nightly log — capability-gated, sits next to Stack
                adherence pill as the other daily-logging surface.
                David 2026-08-11 — moved from Nutrition tab back to
                Scorecard since it's a nightly logging surface, not a
                nutrition-flow item. Self-hides unless CPAP capability
                is enabled in Profile → Devices & Trackers. */}
        ...
        {section === "nutrition" && (
          <div className="space-y-4">
            ...
            {/* CpapNightlyLogCard moved back to Scorecard David 2026-08-11
                (was here on Nutrition tab). Nightly logging belongs
                with the other Scorecard nightly surfaces. */}

            {/* NutritionExtrasCard moved off Scorecard David 2026-08-11 —
                lives on the Nutrition tab (vices, hydration, weight
                logs). Wasn't earning its Scorecard slot. */}
