  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        brand: "5.11",
        description: "Add load to walks, rucks, and bodyweight work. An easy way to raise intensity without more time.",
        price: "$120",
        link: "https://www.amazon.com/s?k=adjustable+weighted+vest",
      },
      {
        id: "jump-rope",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        brand: "AG1",
        description: "All-in-one greens, vitamins, and adaptogens for days your diet falls short. One scoop in water.",
        price: "$79",
      ...
      },
      {
        ...
        name: "Protein Bars",
        brand: "David",
        description: "28g protein, low sugar — a convenient way to hit protein targets between meals.",
        price: "$39",
        link: "https://www.amazon.com/s?k=david+protein+bars",
      },
    ],
  },
];
